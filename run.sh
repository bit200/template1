docker rm -f sess14-main; docker compose --project-name sess14-project -f docker-compose.yml --env-file .env.sess14 up -d;
docker rm -f sess15-main; docker compose --project-name sess15-project -f docker-compose.yml --env-file .env.sess15 up -d
